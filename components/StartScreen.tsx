          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Provador Virtual de Óculos.
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Quer saber como óculos de sol ou de grau ficam no seu rosto? Envie uma foto de retrato sua e experimente diversos modelos de óculos virtualmente com extrema precisão e realismo.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Selecione uma foto nítida e iluminada de rosto. Fotos focando bem o rosto de frente oferecem os melhores resultados.</p>
                <p className="text-gray-500 text-xs mt-1">Ao fazer o upload, você concorda em utilizar o serviço de forma ética, criativa e responsável.</p>
          ...
          <div className="md:w-1/2 flex-shrink-0 flex flex-col items-center md:items-start">
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 leading-tight">
                Seu Retrato de Estúdio
              </h1>
              <p className="mt-2 text-md text-gray-600">
                Arraste o controle deslizante para ver a versão de estúdio sem inteligência de óculos antes do provador.
              </p>
            </div>
            ...
            {isGenerating && (
              <div className="flex items-center gap-3 text-lg text-gray-700 font-serif mt-6">
                <Spinner />
                <span>Gerando seu retrato profissional...</span>
              </div>
            )}
