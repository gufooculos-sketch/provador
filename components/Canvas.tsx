...
const getPoseLabel = (instruction: string): string => {
  if (instruction.includes("front-facing")) {
    return "Frente 📷";
  }
  if (instruction.includes("profile")) {
    return "Perfil 👤";
  }
  return "Direito 📷";
};
      ...
      {displayImageUrl && !isLoading && (
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 bg-white/60 backdrop-blur-md rounded-full p-2 border border-gray-300/50">
            ...
            <span className="text-sm font-semibold text-gray-800 w-48 text-center truncate">
